...
function theme_options_render_page() {
	...
	<div class="wrap">
		<?php screen_icon(); ?>
		<h2><?php printf( __( '%s Theme Options', 'waipoua' ), get_current_theme() ); ?></h2>
		<?php settings_errors(); ?>
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Custom Favicon', 'waipoua' ); ?></th>
					<td>
						...
						<br/><label class="description" for="waipoua_theme_options[custom_favicon]"><?php _e( 'Create a <strong>16x16px</strong> image and generate a .ico favicon using a favicon online generator (e.g. <a href="http://www.faviconr.com/" target="_blank">Faviconr</a>). Now upload your favicon to your themes folder (via FTP) and enter your Favicon URL here (the URL path should be similar to: yourdomain.com/wp-content/themes/waipoua/favicon.ico).', 'waipoua' ); ?></label>
						</fieldset>
					</td>
				</tr>
