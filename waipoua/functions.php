...
load_theme_textdomain( 'waipoua', TEMPLATEPATH . '/languages' );
...
if ( ! function_exists( 'waipoua_comment' ) ) :
/*-----------------------------------------------------------------------------------*/
/* Comments template waipoua_comment
/*-----------------------------------------------------------------------------------*/

function waipoua_comment( $comment, $args, $depth ) {
...
<div class="comment-content">
	...
	?>
	<li class="pingback">
		<p><?php _e( '<span>Pingback:</span>', 'waipoua' ); ?> <?php comment_author_link(); ?></p>
		<p><?php edit_comment_link( __('Edit &rarr;', 'waipoua'), ' ' ); ?></p>
	<?php
			break;
	endswitch;
}
...
class waipoua_flickr extends WP_Widget {
	...
	function waipoua_flickr() {
		$widget_ops = array('description' => 'Show some Flickr preview images.' , 'waipoua');

		parent::WP_Widget(false, __('Flickr Widget', 'waipoua'),$widget_ops);
	}
   ...
   function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Flickr ID (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):','waipoua'); ?></label>
...
class waipoua_video extends WP_Widget {
	...
	function waipoua_video() {
		$widget_ops = array('description' => 'Show a custom featured video.' , 'waipoua');

		parent::WP_Widget(false, __('Video Widget', 'waipoua'),$widget_ops);
	}
...
/*-----------------------------------------------------------------------------------*/
 ...
 class waipoua_sociallinks extends WP_Widget {
	...
	function waipoua_sociallinks() {
		$widget_ops = array('description' => 'Link to your social profiles.' , 'waipoua');

		parent::WP_Widget(false, __('Social Links Widget', 'waipoua'),$widget_ops);
	}
   ...
   function form($instance) { 
		...
		<p>
			<input class="checkbox" type="checkbox" <?php checked( $instance['target'], true ); ?> id="<?php echo $this->get_field_id('target'); ?>" name="<?php echo $this->get_field_name('target'); ?>" <?php checked( $target, 'on' ); ?>> <?php _e('Open all links in a new browser tab', 'waipoua'); ?></input>
		</p>
